...
- Redis는 요청을 선별하지만, 최종 발급 여부는 PostgreSQL 저장 결과를 기준으로 판단합니다.
...
Lost Update는 발생 과정을 쉽게 이해할 수 있도록 5단계 playback을 제공합니다.
...
Playback은 대표 요청 A와 B를 사용한 개념 설명입니다. 실제 15건의 기록 결과와 전략별 결과는 comparison card에서 확인할 수 있습니다. 자동 진행, 다시 보기, 완료 후 단계 선택을 지원합니다.
